...
r = 10
filename = f"optimal_solution_of_Model_lblock64_{r}_round_searchForBestDifferentialCharacteristic_BranchBound_model.lp.txt"
# filename = f"optimal_solution_of_Model_lblock64_{r}_round_calculateMinNumOfDifferentiallyActiveSbox_BranchBound_model.lp.txt"
for i in range(r):
