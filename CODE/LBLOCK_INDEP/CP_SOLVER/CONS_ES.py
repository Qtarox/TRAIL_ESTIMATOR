...
from TOOL.Visual import show_cons_set, show_Lblock_equ
import random
...
def show_constraint_set(nmat,equ_dic,nlmat):
    ...
    for i in range(np.shape(nlmat)[0]):
        ...
        for k in range(8*round_num):
            if(nlmat[i][k+round_num*24+24]==1):
                str_tmp=str_tmp+' + k_'+str(k)
        str_tmp=str_tmp+'= 0 '
        print(str_tmp)
        equ_LST.append(str_tmp)
...
if __name__=="__main__":
    RES_C=RES_DC2_SOL
    tst=[[172, 182, 189, 199, 358], [127, 129, 153, 163, 170, 175, 177, 180, 338, 347], [122, 132, 156, 166], [121, 131, 155, 165], [107, 117], [61, 71, 95, 97], [45, 47, 49, 55, 59, 69, 93, 103, 283, 295], [62, 64, 88, 98], [28, 38, 44, 54, 276]]
    process_cons(tst)
