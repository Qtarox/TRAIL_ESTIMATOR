...
def cons_cp_solve(res_name,cons_name):
    ...
    for k1 in range(1):
        for k2 in range(1):
            ...
            # model.add_string("""constraint k_23 = 0;""")
            # model.add_string(f"constraint k_14 = 0;")
            # model.add_string(f"constraint k_10 = 0;")
            # model.add_string(f"constraint k_17 = 0;")
            # model.add_string(f"constraint k_19 = 0;")
            # model.add_string(f"constraint k_22 = 0;")
            # model.add_string(f"constraint k_31 = 0;")
            # model.add_string(f"constraint k_24 = 0;")
            # model.add_string(f"constraint k_28 = 0;")
            # model.add_string(f"constraint k_32 = 0;")
            # model.add_string(f"constraint k_34 = 0;")
